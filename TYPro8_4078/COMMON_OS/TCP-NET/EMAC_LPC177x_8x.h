...
/* EMAC Memory Buffer configuration for 32K Ethernet RAM. USB LCD 16K. */
#define NUM_RX_FRAG         13           /* Num.of RX Fragments 4*1536= 6.0kB */
#define NUM_TX_FRAG         8           /* Num.of TX Fragments 3*1536= 4.6kB */
...
#define swab32(x) \
	...
	(((U32)(x) & (U32)0x0000ff00UL) <<   |     \
	(((U32)(x) & (U32)0x00ff0000UL) >>   |     \
...
#define IPGR_DEF_PART2      0x00000012  /* Recommended value                 */
#define IPGR_DEF_PART1      0x00000C00  /* Recommended value                 */
...
//#define PHY_AUTO_NEG        0x3000      /* Select Auto Negotiation    100 Mb/s,Normal operation.*/
//#define PHY_AUTO_NEG        0x1200      /* Select Auto Negotiation    10  Mb/s ,Restart Auto-Negotiation*/
//#define PHY_AUTO_NEG        0x1000      /* Select Auto Negotiation  自动协商10Mbit,正常操作。*/
#define PHY_AUTO_NEG        0x1200      /* Select Auto Negotiation           */


/* PHY_REG_LEDCR  LED Direct Control Register   Word */
#define      LEDCR_DRIVE_SPEED      0x0020        /*   Drive SPEED LED    */
#define      LEDCR_DRIVE_LINK       0x0010        /*   Drive LINK  LED      */
#define      LEDCR_DRIVE_ACT        0x0008       /*    Drive ACT LED    */
#define      LEDCR_SET_SPEED        0x0004        /*   SPEED LED   Value */
#define      LEDCR_SET_LINK         0x0002        /*    LINK   LED   Value  */
#define      LEDCR_SET_ACT          0x0001       /*     ACT   LED    Value */
...
#define MYMAC_1         0x00            /* our ethernet (MAC) address        *///具体物理地址
#define MYMAC_2         0x30//0x00            /* (MUST be unique in LAN!)          */
#define MYMAC_3         0x6C//0x00
#define MYMAC_4         0x00
#define MYMAC_5         0x00
#define MYMAC_6         0x00
