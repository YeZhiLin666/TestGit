...
#define TICK_INTERVAL  10    // 将TCP网络的时间分辨率提高到10ms，
...
//     <i> Default: 0x30
#define _MAC2          0x00		//0x03

//     <o>Address byte 3 <0x00-0xff>
//     <i> Default: 0x6C
#define _MAC3          0x00		//0x47

//     <o>Address byte 4 <0x00-0xff>
//     <i> Default: 0x00
#define _MAC4          0x00		//0xD5

//     <o>Address byte 5 <0x00-0xff>
//     <i> Default: 0x00
#define _MAC5          0x00		//0x04

//     <o>Address byte 6 <0x00-0xff>
//     <i> Default: 0x01
#define _MAC6          0x00		//0x5E
...
#define TCP_RETRYTOUT  0.05  //   默认的4秒或1秒重发一个TCP包太慢了，将会丢失下位机很多数据改为50ms。
...
//#include <Net_lib.c>
#include "../../COMMON_os/Tcp-net/Net_lib.c" 
