...
void init_ethernet (void) {
	...
	// LPC_EMAC->RxFilterCtrl = RFC_MCAST_EN | RFC_BCAST_EN ;
	...
	if ( Local_irq( ENET_IRQn, HIGHEST_PRIORITY + 14) == FALSE )
	{
		return ;
	}
