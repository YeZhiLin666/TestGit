...
#ifndef _ADC24bit_AD7190_H_
#define _ADC24bit_AD7190_H_

//¼Ä´æÆ÷
/* AD7190 GPIO */
#define GPIO1_STATE (1<<23)//P1.23
#define AD7190_RDY_STATE       GPIO1_STATE
#define ADC_AD7190_TIME_OUT 50000
...
#define AD7190_CONF_CHAN(x)     ((unsigned long)((x) & 0x3FF) << 8) // Channel select.
...
public:
    ...
    static unsigned long int  AD7190_Read(char chn,char IVtype);

    static unsigned long AD7190_GetRegisterValue(unsigned char registerAddress,
...
private:
    ...
    static unsigned char WaitRdyGoLow(void);
    static void Reset(void);
    static void AD7190_RangeSetup(unsigned char polarity, unsigned char range);

    static void AD7190_SetRegisterValue(unsigned char registerAddress,
                                        unsigned long registerValue,
                                        unsigned char bytesNumber,
                                        unsigned char modifyCS);

    static void AD7190_ChannelSelect(unsigned short channel);
    static unsigned long AD7190_SingleConversion(void);
