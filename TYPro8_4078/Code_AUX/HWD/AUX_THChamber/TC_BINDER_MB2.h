/*****************************************************************************
// 程序文件      :TC_BINDER_MB2.H    定义温控箱中各种处理头文件
...
//  回应包长度限制
#define TC_MB2_MIN_RESPONSE_CMD_NUM        1 // 3帧   // 回应包最小数量限制 //1
#define TC_MB2_MAX_RESPONSE_CMD_NUM        1 // 9帧   // 回应包最大数量限制
#define TC_MB2_MIN_RESPONSE_CMD_LEN		(TC_MB2_MIN_RESPONSE_CMD_NUM*TC_MB2_MAX_COM_READ_REPLY)    // 3帧*N  // 回应包最小长度限制
#define TC_MB2_MAX_RESPONSE_CMD_LEN		(TC_MB2_MAX_RESPONSE_CMD_NUM*TC_MB2_MAX_COM_READ_REPLY)    // 9帧*N  // 回应包最大长度限制
