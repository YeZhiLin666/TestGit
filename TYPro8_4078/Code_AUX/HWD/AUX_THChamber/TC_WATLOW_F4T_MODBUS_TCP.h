/*****************************************************************************
// 程序文件      :TC_WATLOW_F4T_MODBUS_TCP.h    定义温控箱中各种控制命令头文件
...
#define TC_WATLOW_F4T_MODBUS_TCP_INPUT_FIRST		1    //  第一通道输入   // 写 0x012C = 300   读 0x0064 = 100
#define TC_WATLOW_F4T_MODBUS_TCP_INPUT_THIRD 		3    //  第三通道输入   // 写 0x0272 = 626   读 0x006C = 108
