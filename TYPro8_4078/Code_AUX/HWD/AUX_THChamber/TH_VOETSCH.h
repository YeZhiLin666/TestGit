/*****************************************************************************
// 程序文件      :TH__VOETSCH.h    定义温控箱中各种处理头文件
...
//  回应包长度限制
#define TH_VOETSCH_MIN_RESPONSE_CMD_LEN		2*TH_VOETSCH_MAX_COM_READ_REPLY    // 15  // 回应包最小长度限制
#define TH_VOETSCH_MAX_RESPONSE_CMD_LEN		6*TH_VOETSCH_MAX_COM_READ_REPLY  //  4*MAX_COM_READ_REPLY    // 40  // 回应包最大长度限制
