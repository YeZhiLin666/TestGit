...
#ifndef _LBT2401_SampleManage_H_
#define _LBT2401_SampleManage_H_

#define LBT2401_ADC_NUM 2
#define LBT2401_ADC_I_CHN_MAX  15  //(MAXCHANNELNO)  // 16

#define LBT2401_ADC_DG_BUILT_UP_TIME_TICKS    6    //模拟门建立时间  600us

class LBT2401_SampleManage
{
public:
