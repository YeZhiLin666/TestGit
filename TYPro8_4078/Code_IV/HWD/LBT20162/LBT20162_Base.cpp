...
#endif
St_DisposableTask LBT20162_Base::SetCtrlOpenCh[5];
St_DisposableTask LBT20162_Base::SetCtrlCloseCh[3];
St_DisposableTask LBT20162_Base::SetCCToCC[4];    //加入了多range切换，所以这里扩充到10步
St_DisposableTask LBT20162_Base::SetRstToOff[3];
St_DisposableTask LBT20162_Base::SetCtrlOpenAcim[1];
St_DisposableTask LBT20162_Base::SetCtrlCloseAcim[1];
#if (IV_AUTORANGE == 1)
St_DisposableTask LBT20162_Base::SetAutoRangeSwitch[4];
#endif
#pragma arm section

void LBT20162_Base::FeatureEnable_Init(void)
{
...
//	board_config::DacInfo.m_uSettingTime = 1000;
    ...
    board_config::DacInfo.m_uRisingTime = LBT20162_RISING_TIME;// Rising time,  unit is 100us
    board_config::DacInfo.m_fPID_Coefficient = LBT20162_Tpid_Tsys;
...
void LBT20162_Base::AdditionalEngine(void)
{
    // ACIM Engine
    OS_LogicProcess::SetCtrlAcimOn.st_Disposabletask_ptr = &LBT20162_Base::SetCtrlOpenAcim[0];
    OS_LogicProcess::SetCtrlAcimOn.stepLen = sizeof(SetCtrlOpenAcim) / sizeof(St_DisposableTask);

    OS_LogicProcess::SetCtrlAcimOff.st_Disposabletask_ptr = &LBT20162_Base::SetCtrlCloseAcim[0];
    OS_LogicProcess::SetCtrlAcimOff.stepLen = sizeof(SetCtrlCloseAcim) / sizeof(St_DisposableTask);

}

void LBT20162_Base::EngineStuff(void)
{
...
// 	SetCtrlCloseCh[0].RelayMove.ActiveFlag = LBT20162_RLY_Protect;
    SetCtrlCloseCh[1].uw32_DelayTime = 50;
    SetCtrlCloseCh[1].RelayMove.InactiveFlag = LBT21XXX_RLY_ACIM;
...
// 	SetCtrlCloseCh[2].RelayMove.InactiveFlag = LBT20162_RLY_Protect;
