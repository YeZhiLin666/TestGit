...
//把LBT20162_Base内的采样ProcessADC转移进来
...
char LBT20162_SampleManage::SampleISR(unsigned long CH_Number,unsigned long type)
{
    ...
    case LBT20162_ADC_IDLE:
        ...
        TimeTicks = 0;
        m_ADC_chn = 0;
        Adc24bit_AD7175::ADC_CS= LBT20162_Base::PinGroup[LBT20162_Pin_AdcCS1];  //电流
        ControlPin::SetMeHigh(Adc24bit_AD7175::ADC_CS);
        Adc24bit_AD7175::ADC_CS= LBT20162_Base::PinGroup[LBT20162_Pin_AdcCS2];   //电压
        ControlPin::SetMeHigh(Adc24bit_AD7175::ADC_CS);
...
//            ADC_Status = LBT20162_ADC_NoWork;    //省去了开关模拟门的时序
        }
        else
