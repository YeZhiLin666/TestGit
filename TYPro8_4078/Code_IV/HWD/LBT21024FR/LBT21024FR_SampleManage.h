...
#ifndef _LBT21024FR_SampleManage_H_
#define _LBT21024FR_SampleManage_H_

#define LBT21024FR_ADC_NUM 2
#define LBT21024FR_ADC_I_CHN_MAX  15  //(MAXCHANNELNO)  // 16

#define LBT21024FR_ADC_DG_BUILT_UP_TIME_TICKS    6    //模拟门建立时间  600us

class LBT21024FR_SampleManage
{
 public:
